...
do
  ...
  do
    ...
    --output-dir output/base2new/train_base/${dataset}/shots_4/CoOp_sub/rn50_ep100/seed${seed} \
    DIRECT_RESUME output/base2new/train_base/${dataset}/shots_4/CoOp/rn50_ep100/seed${seed}/prompt_learner/model.pth.tar-1 \
