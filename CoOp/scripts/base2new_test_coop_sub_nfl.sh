...
do
  ...
  do
    ...
    --output-dir output/base2new/test_${sub}/${dataset}/shots_4/CoOp_sub_nfl/rn50_ep100/seed${seed}/${loadep} \
    --model-dir output/base2new/train_base/${dataset}/shots_4/CoOp_sub_nfl/rn50_ep100/seed${seed} \
    --load-epoch ${loadep} \
    --eval-only \
